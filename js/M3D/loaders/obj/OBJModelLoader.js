...
(function () {
    ...
    /** 
     * @description: Store geometry poligonal face data on buffers using 
    ...
    OBJModelLoader.Material.Color = function (clonedColor) {
        ...
        Object.defineProperty(color, 'alpha', {
            configurable: false,
            get: function () {
                return this[3];
            }, set: function (value) {
     ...
     * @returns {undefined}
     */
    OBJModelLoader.Material.Color.prototype.set = function (red, green, blue, alpha) {
        this[0] = red;
        this[1] = green;
        this[2] = blue;
        this[0] = alpha
